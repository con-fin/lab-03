...
author: "Connor Finlay, Murray Bone, Alexander Patton and Cameron + Ade - Team Name"
date: "`r Sys.Date()`"
...
What is the difference between *wide format* data and *long format* data?
  Wide format is lots of different variables and few observations. Long data is lots of observations and few variables.
...
# staff_long <- staff %>%
 # pivot_longer(
  #  cols = , 
   ...
   #values_to = "percent"
   #)
>>>>>>> 4a4c0e85e1379dc0d86ea608b5f1e9e3dd34c2f0
